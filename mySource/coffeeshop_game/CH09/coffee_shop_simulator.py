...
class CoffeeShopSimulator:
    ...
    def run(self):
        ...
        while running:
            ...
            cup_price = convert_to_float(prompt("What do you want to charge for a cup of coffee?"))
    ...
    def simulate(self, temperature, advertising, cup_price):
        ...
        # Save the sales data for the day
        self.sales.append({
            "day": self.day,
        ...
        # We technically don't need this, but why make the next step read from the
        # Sales list when we have the data right here?
        return cups_sold
    ...
    def make_temp_distribution(self):
        ...
        temps = []
        # First we find the average between TEMP_MIN and TEMP_MAX
        ...
        for i in range(self.TEMP_MIN, self.TEMP_MAX):
            ...
            dist_from_average = abs(avg - i)
            # How far away is the dist_from_avg from the maximum?
            # This will be lower for temps at the extremes
            dist_from_max_dist = max_dist_from_avg - dist_from_average
            # If the value is 0, make it 1
            if dist_from_max_dist == 0:
                dist_from_max_dist = 1
            # Append the output of x of y to temps
    ...
    def day_header(self):
        print(f"-----| Day {self.day} @ {self.shop_name} |-----")
