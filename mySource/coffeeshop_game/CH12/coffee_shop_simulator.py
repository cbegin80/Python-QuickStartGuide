...
class CoffeeShopSimulator:
    ...
    def __init__(self):
        ...
        self.shop_name = self.prompt("What do you want to call your coffee shop?", True)
    ...
    def run(self):
        ...
        while running:
            ...
            response = self.prompt("What do you want to charge for a cup of coffee? (type exit to quit)")
            ...
            response = self.prompt("Want to buy more coffee? (hit ENTER for none or enter number)", False)
